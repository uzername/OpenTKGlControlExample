...
namespace OpenTKFinalAttempt
{
    ...
    class Camera
    {
        ...
        public Matrix4 GetViewMatrix()
        {
            ...
            /*
            Matrix4 rotOperator1 = Matrix4.CreateRotationX((float)Orientation.X) * Matrix4.CreateRotationX((float)Orientation.Y) * Matrix4.CreateRotationX((float)Orientation.Z);
            // https://www.youtube.com/watch?v=RqZH-7hlI48
            Vector4 newUp = new Vector4(Vector4.UnitY.X, Vector4.UnitY.Y, Vector4.UnitY.Z, 1) * rotOperator1;
            Vector3 meowUp = new Vector3(newUp.X,newUp.Y, newUp.Z);
            return Matrix4.LookAt(Position, Position + lookat, meowUp);
            */
        }
